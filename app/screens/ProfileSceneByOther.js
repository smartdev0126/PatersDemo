...
export default function ProfileSceneByOther({ navigation }) {
  return (
    <SafeAreaView style={styles.Container}>
      <ScrollView>
        <UpperComponent onPress={() => navigation.goBack()} name={"Masa"} />
        ...
        <View style={styles.MiddleImageContainer}>
          <View style={styles.LeftImageContainer}>
            <Image
              source={require("../../assets/ProfileScene/Men2.png")}
              style={styles.img}
            />
          </View>
          <View style={styles.RightImageContainer}>
            <Image
              source={require("../../assets/ProfileScene/Men3.png")}
              style={styles.img}
            />
          </View>
        </View>
