    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <View style={styles.TextTopContainer1}>
          <Text style={styles.TopText}>You Can Meat Easily</Text>
        </View>

        <View style={styles.TextTopContainer2}>
          <Text style={styles.TopText}>All You Need To DO Is To Choose</Text>
          <Text style={styles.TopText}>A Place And Date</Text>
          <Text style={styles.TopText}>All You Need To DO Is To Choose</Text>
          <Text style={styles.TopText}>A Place And Date</Text>
        </View>

        <View style={styles.ForOneCircle}>
